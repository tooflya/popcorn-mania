...
void BatchEntityManager::init(int pCreateCount, Entity* pEntity, CCNode* pScreen, int pZOrder)
	{
		...
		pScreen->addChild(this, pZOrder);
	}

BatchEntityManager::BatchEntityManager(int pCreateCount, Entity* pEntity, CCNode* pScreen, int pZOrder) :
    CCSpriteBatchNode()
    {
        this->init(pCreateCount, pEntity, pScreen, pZOrder);
    }

BatchEntityManager::BatchEntityManager(int pCreateCount, Entity* pEntity, CCNode* pScreen) :
    CCSpriteBatchNode()
    {
        this->init(pCreateCount, pEntity, pScreen, 0);
    }
